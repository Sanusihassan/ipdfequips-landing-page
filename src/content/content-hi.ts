...
export const landing_page: _landing_page = {
  hero: {
    title:
      "पीडीएफ फाइलों के साथ काम करने के लिए आवश्यक सभी उपकरण एक ही स्थान पर",
    description:
      "आप जितने भी पीडीएफ टूल की कल्पना कर सकते हैं वे सभी आपके पास आसानी से उपलब्ध हैं। पूरी तरह से मुफ़्त और उपयोग में आसान! आप बस कुछ ही क्लिक के साथ आसानी से पीडीएफ फाइलों को मर्ज, स्प्लिट, कंप्रेस, कन्वर्ट, रोटेट, ओपन और वॉटरमार्क जोड़ सकते हैं।",
  },
  features: {
    title: "PDFEquips आपके PDF कार्यों को कैसे सरल बना सकता है",
    description:
      "PDFEquips प्रारूप रूपांतरण, लचीले संपादन और कुशल फ़ाइल संगठन के लिए उपकरण प्रदान करके पीडीएफ फ़ाइल प्रबंधन को सरल बनाता है। उन्नत सुरक्षा सुविधाएँ. अपने सहज इंटरफ़ेस, व्यापक संपादन क्षमताओं और ओसीआर तकनीक के साथ, यह स्कैन किए गए दस्तावेज़ों से एनोटेशन और टेक्स्ट निष्कर्षण जैसे कार्यों को सरल बनाता है। बैच प्रसंस्करण और स्वचालन सुविधाएँ उत्पादकता को बढ़ाती हैं। PDFEquips पेशेवरों को PDF फ़ाइलों की पूरी क्षमता को अनलॉक करने देता है।",
  },
  why_us: {
