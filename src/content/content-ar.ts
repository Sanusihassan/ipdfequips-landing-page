...
export const landing_page: _landing_page = {
  hero: {
    ...
    description:
      "حرر ملفات PDF مثل المحترفين مع PDFEquips! جميع الأدوات التي تحتاجها، مجانًا وسهلة الاستخدام. دمج، تقسيم، ضغط، تحويل، تدوير، وإضافة العلامات المائية ببضع نقرات فقط.",
  },
  features: {
    title: "كيف يمكن لـ PDFEquips تبسيط مهام PDF الخاصة بك",
    description:
      "يجعل PDFEquips إدارة ملفات PDF سهلة باستخدام أدوات شاملة لتحويل الملفات وتحريرها وتنظيمها. استمتع بالأمان المحسن، وواجهة سهلة الاستخدام، وتقنية OCR، والمعالجة الجماعية لتعزيز الإنتاجية. مثالي للمهنيين لاستخراج أفضل ما في ملفات PDF.",
  },
  why_us: {
    title: "حل PDF الذي يمكنك الاعتماد عليه",
    description:
      "PDFEquips هو تطبيق الويب الذي يمكنك الاعتماد عليه لإدارة ملفات PDF بسهولة. احصل على جميع الميزات التي تحتاجها للعمل مع المستندات الرقمية، وكلها في مكان آمن واحد.",
  },
  // alert: {
