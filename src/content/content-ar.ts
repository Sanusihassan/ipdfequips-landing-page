...
export const landing_page: _landing_page = {
  hero: {
    title: "جميع الأدوات التي تحتاجها للعمل مع ملفات PDF في مكان واحد",
    description:
      "جميع أدوات PDF التي يمكنك تخيلها متاحة بسهولة تحت تصرفك. مجاني تماما وسهل الاستخدام! يمكنك دمج وتقسيم وضغط وتحويل وتدوير وفتح وإضافة علامات مائية إلى ملفات PDF دون عناء ببضع نقرات فقط.",
  },
  features: {
    title: "كيف يمكن لـ PDFEquips تبسيط مهام PDF الخاصة بك",
    description:
      "يعمل PDFEquips على تبسيط إدارة ملفات PDF من خلال تقديم أدوات لتحويل التنسيق والتحرير المرن وتنظيم الملفات بكفاءة. ميزات الأمان المحسنة. بفضل واجهته البديهية وإمكانيات التحرير الشاملة وتقنية التعرف الضوئي على الحروف، فإنه يبسط المهام مثل التعليقات التوضيحية واستخراج النص من المستندات الممسوحة ضوئيًا. تعمل ميزات معالجة الدفعات والأتمتة على تعزيز الإنتاجية. يتيح PDFEquips للمحترفين فتح الإمكانات الكاملة لملفات PDF.",
  },
  why_us: {
